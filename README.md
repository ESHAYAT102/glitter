...
Install Glitter to `${XDG_BIN_HOME:-$HOME/.local/bin}`:

```sh
curl -fsSL https://raw.githubusercontent.com/ESHAYAT102/glitter/main/scripts/install.sh | sh
```

Uninstall:

```sh
curl -fsSL https://raw.githubusercontent.com/ESHAYAT102/glitter/main/scripts/uninstall.sh | sh
```
